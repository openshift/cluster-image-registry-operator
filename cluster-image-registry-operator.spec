...
%global package_name ose-cluster-image-registry-operator
%global product_name ose-cluster-image-registry-operator
%global import_path github.com/openshift/cluster-image-registry-operator

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        OSE Cluster Image Registry Operator
License:        ASL 2.0
...
for bin in cluster-image-registry-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-image-registry-operator
