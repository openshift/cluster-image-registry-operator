...
import (
	...
	v1 "github.com/openshift/cluster-image-registry-operator/pkg/generated/listers/pruner/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PrunerV1().Configs().List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PrunerV1().Configs().Watch(options)
			},
		},
		&prunerv1.Config{},
		resyncPeriod,
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&prunerv1.Config{}, f.defaultInformer)
}
