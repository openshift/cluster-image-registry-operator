...
type Interface interface {
	...
	Imageregistry() imageregistryv1alpha1.ImageregistryV1alpha1Interface
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.imageregistryV1alpha1, err = imageregistryv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.imageregistryV1alpha1 = imageregistryv1alpha1.NewForConfigOrDie(c)
