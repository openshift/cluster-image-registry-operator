...
func (d *driver) getAzureConfig() (*clusterconfig.Azure, error) {
	cfg, err := clusterconfig.GetAzureConfig(d.Listers)
	if err != nil {
		return nil, err
	}
	return cfg, nil
...
func (d *driver) storageAccountsClient(cfg *clusterconfig.Azure) (storage.AccountsClient, error) {
